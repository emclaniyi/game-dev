...
export class Game {
    ...
    fight = (attackingPlayer, otherPlayer) => {
        ...
        if(player2.lifePoints <= 0){
            ...
            $('#gameover-modal').show();
            $('#fight-modal').hide();
            $("#winner-avatar").append('<img class="player-player1" src="img/naija.png" alt="Player-1" />');
        ...
        if(player1.lifePoints <= 0){
            ...
            $("#winner-avatar").append('<img class="player-player2" src="img/hunter.png" alt="Player-2" />')
